...
export const cashAllocationGuard: CanActivateFn = () => {
  ...
  const canRead =
    ...
    permissions.includes('READ_BASE_TELLER_CASH_ALLOCATION');
  return canRead || inject(Router).createUrlTree(['/organization/base-teller']);
};
