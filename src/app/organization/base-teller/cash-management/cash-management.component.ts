  ...
  loadOptions(): void {
    ...
    forkJoin({
      ...
      .subscribe({
        ...
        error: (error: unknown) => this.setError(error, 'web1232.errors.options')
      });
  }
  ...
  tellerChanged(tellerId: FineractId | null): void {
    ...
    this.service
      ...
      .subscribe({
        ...
        error: (error: unknown) => this.setError(error, 'web1232.errors.cashiers')
      });
  }
  ...
  loadContext(): void {
    ...
    this.service
      ...
      .subscribe({
        ...
        error: (error: unknown) => this.setError(error, 'web1232.errors.context')
      });
  }
  ...
  submitClosing(): void {
    ...
    this.service
      ...
      .subscribe({
        ...
        error: (error: unknown) => this.setError(error, 'web1232.errors.closing')
      });
  }
  ...
  submitOperation(): void {
    ...
    this.service
      ...
      .subscribe({
        ...
        error: (error: unknown) => this.setError(error, 'web1232.errors.operation')
      });
  }
  ...
  loadReceipt(): void {
    ...
    this.service
      ...
      .subscribe({
        ...
        error: (error: unknown) => this.setError(error, 'web1232.errors.receipt')
      });
  }
  ...
  loadGlobalCount(): void {
    ...
    this.service
      ...
      .subscribe({
        ...
        error: (error: unknown) => this.setError(error, 'web1232.errors.global')
      });
  }
  ...
  loadHistory(event?: PageEvent): void {
    ...
    this.service
      ...
      .subscribe({
        ...
        error: (error: unknown) => this.setError(error, 'web1232.errors.history')
      });
  }
  ...
  loadHoldings(): void {
    ...
    this.service
      ...
      .subscribe({
        ...
        error: (error: unknown) => this.setError(error, 'web1232.errors.holdings')
      });
  }
